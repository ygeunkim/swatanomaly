...
#' @importFrom Rcpp sourceCpp
#' @export
partnnd <- function(data, win, jump, partition, base_id, d) {
    .Call('_swatanomaly_partnnd', PACKAGE = 'swatanomaly', data, win, jump, partition, base_id, d)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
nnd_normal <- function(data, part, win, jump, d, display_progress = FALSE) {
    .Call('_swatanomaly_nnd_normal', PACKAGE = 'swatanomaly', data, part, win, jump, d, display_progress)
}
...
#' @importFrom Rcpp sourceCpp
#' @export
pred_nnd <- function(data, newdata, win, jump, d, display_progress = FALSE) {
    .Call('_swatanomaly_pred_nnd', PACKAGE = 'swatanomaly', data, newdata, win, jump, d, display_progress)
}
