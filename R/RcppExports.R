...
#' @export
reduce_pca <- function(x, win, jump) {
    .Call('_swatanomaly_reduce_pca', PACKAGE = 'swatanomaly', x, win, jump)
}
...
#' @import RcppArmadillo
#' @export
reduce_mds <- function(x, win, jump) {
    .Call('_swatanomaly_reduce_mds', PACKAGE = 'swatanomaly', x, win, jump)
}
